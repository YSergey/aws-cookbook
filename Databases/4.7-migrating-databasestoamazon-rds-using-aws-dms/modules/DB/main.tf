...
resource "aws_secretsmanager_secret_version" "db_secret_version" {
  secret_id     = aws_secretsmanager_secret.db_secret.id
  secret_string = "{\"password\":\"${var.static_db_password}\"}"
}
...
resource "aws_rds_cluster" "aurora_cluster" {
  ...
  master_password         = var.static_db_password
...
resource "aws_rds_cluster_instance" "rds_source_instance" {
  # identifier         = "database-cluster-source-instance"
...
resource "aws_rds_cluster_instance" "rds_target_instance" {
  # identifier         = "database-cluster-target-instance"
  identifier = var.target_db_identifier
  cluster_identifier = aws_rds_cluster.aurora_cluster.id
